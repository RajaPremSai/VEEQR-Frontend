        ...
        <div style={{overflowX: 'auto'}}>
          <table style={{width: '100%', borderCollapse: 'collapse'}}>
            <tbody>
              ...
              <tr style={{borderBottom: '1px solid #ddd'}}>
                <td style={{padding: '8px', border: '1px solid #ddd', fontWeight: 'bold', backgroundColor: '#f5f5f5'}}>User Type</td>
                <td style={{padding: '8px', border: '1px solid #ddd'}}>{profile.userType}</td>
              </tr>
              <tr style={{borderBottom: '1px solid #ddd'}}>
