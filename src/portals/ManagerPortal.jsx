  ...
  return (
    <div>
      ...
      <div className="container">
        <div className="card">
          <Link to=".">Dashboard</Link> · <Link to="users">Users</Link> · <Link to="gates">Gates</Link> · <Link to="u-vehicles">University Vehicles</Link> · <Link to="announcements">Announcements</Link> · <Link to="guards">Security Guards</Link> · <Link to="logs">Logs</Link>
        </div>
        <Routes>
